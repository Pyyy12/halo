   ...
   private function exportXls($books)
{
    ...
    // 2. Pastikan tidak ada output lain sebelum file dibuat
    if (ob_get_level() > 0) ob_end_clean();

    // 3. Mulai proses Excel
    $excel = \Excel::create('Data Buku Larapus', function($excel) use ($books) {
    ...
    // 4. Download file dan langsung hentikan script agar tidak ada error setelahnya
